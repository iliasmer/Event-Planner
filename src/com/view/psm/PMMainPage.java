...
public class PMMainPage {
        ...
        generalList.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    JFrame child = PSMViewEvent.createPSMViewEvent(((EventRequest)eventRequestItem.getRequest()).getEvent());
                    children.add(child);
                }
            }
        });
    ...
    public static void createPMMainPage(String username) {
        children = new ArrayList<JFrame>();
        jFrame = new JFrame("Main page (PM)");
        PMMainPage pmMainPage = new PMMainPage();
        jFrame.setContentPane(pmMainPage.jPanel);
        jFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        pmMainPage.showEventRequests();
        pmMainPage.showMembers(username);
        pmMainPage.loggedIn.setText("Logged in: " + username);
        jFrame.pack();
